...
export const WHOLE_CAKES = [
  ...
  { id: 203, name: "Chocoquesillo 1kg", price: 15, currency: "USD" },
  { id: 204, name: "Chocoquesillo decorado 1kg", price: 20, currency: "USD" },
  { id: 205, name: "Selva Negra 1kg", price: 15, currency: "USD" },
  { id: 206, name: "Selva Negra 2kg", price: 25, currency: "USD" },
  { id: 207, name: "Oreo 1kg", price: 15, currency: "USD" },
  { id: 208, name: "Oreo 2kg", price: 25, currency: "USD" },
  { id: 209, name: "Pie 2kg", price: 30, currency: "USD" },
  { id: 210, name: "3 Leches 1.5kg", price: 20, currency: "USD" },
  { id: 211, name: "Beso de Angel 2kg", price: 30, currency: "USD" },
  { id: 212, name: "Beso de Angel 4kg", price: 50, currency: "USD" },
  { id: 213, name: "Red Velvet 1kg", price: 20, currency: "USD" },
  { id: 214, name: "Red Velvet 2kg", price: 40, currency: "USD" },
  { id: 215, name: "Cheesecake 2kg", price: 40, currency: "USD" },
  { id: 216, name: "Vainifresa 2kg", price: 25, currency: "USD" },
];

export const DRINKS = [
  { id: 101, name: "Malta", price: 200, currency: "VES" },
  { id: 102, name: "Refresco", price: 200, currency: "VES" },
